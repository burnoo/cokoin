...
dependencies {
    ...
    implementation("dev.burnoo:cokoin-android-viewmodel:0.3.3") // for Androidx ViewModel
    implementation("dev.burnoo:cokoin-android-navigation:0.3.3") // for Compose Navigation
